...
4. **사용 시작** 후 매일 **오늘 간편식 받았어요**를 누르면 됩니다.
   ...
   받은 날은 달력에 초록색 **✓ 받음** 배지로 표시됩니다. 달력의 날짜를 누르면 다른 날도 수령으로 기록하거나 취소할 수 있습니다.
...
| `e2e/devices.spec.ts` | 브라우저 재실행 후 유지, 잘못된 백업 거부, 다크 모드, iPhone SE, 데스크톱, '✓ 받음' 배지, 오늘 표시 링 |
...
- `tests/fixtures/synthetic-2026-11.png`, `synthetic-2026-12.png` — **합성** fixture(한 장 추가 흐름 테스트용).
  실제 11·12월 스크린샷이 없어서, 실제 10월 화면의 칸 조각(원·'휴'·날짜 숫자)을 옮겨 붙여 만들었습니다
...
- 시작 요일과 주 수가 같은 두 달(예: 2026년 9월과 12월)은 달력 배치가 거의 같아서, 다른 달 사진을 넣어도
  판독기가 알아차리지 못할 수 있습니다. 한 장 추가 후 **달 확인 화면**에서 근무가 맞는지 꼭 확인해 주세요.
